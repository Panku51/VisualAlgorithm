...
class InsertionSort extends JFrame{
	...
	public static void main(String args[]){
		InsertionSort runner = new InsertionSort();
		runner.InsertionSorting();
		//new InsertionSort();
	}
}
